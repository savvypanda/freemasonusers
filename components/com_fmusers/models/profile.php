...
/**
 * Profile model class for Fmusers.
 *
 * @package		Joomla.Site
 * @subpackage	com_fmusers
 * @since		1.6
 */
class FmusersModelProfile extends JModelForm
{
	/**
	...
	{
		// Get the form.
		$form = $this->loadForm('com_fmusers.profile', 'profile', array('control' => 'jform', 'load_data' => $loadData));
		if (empty($form)) {
			return false;
		}
