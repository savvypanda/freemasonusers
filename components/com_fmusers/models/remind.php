...
/**
 * Remind model class for Fmusers.
 *
 * @package		Joomla.Site
 * @subpackage	com_fmusers
 * @version		1.5
 */
class FmusersModelRemind extends JModelForm
{
	/**
	...
	{
		// Get the form.
		$form = $this->loadForm('com_fmusers.remind', 'remind', array('control' => 'jform', 'load_data' => $loadData));
		if (empty($form)) {
			return false;
		}
	...
	public function processRemindRequest($data)
	{
		...
		$link	= 'index.php?option=com_fmusers&view=login'.$itemid;
