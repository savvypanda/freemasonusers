...
/**
 * Reset controller class for Fmusers.
 *
 * @package		Joomla.Site
 * @subpackage	com_fmusers
 * @version		1.6
 */
class FmusersControllerReset extends FmusersController
{
	/**
	...
	public function request()
	{
		...
		$model	= $this->getModel('Reset', 'FmusersModel');
		...
		if ($return instanceof Exception) {
			...
			$itemid = FmusersHelperRoute::getResetRoute();
			$itemid = $itemid !== null ? '&Itemid='.$itemid : '';
			$route	= 'index.php?option=com_fmusers&view=reset'.$itemid;
			...
			$itemid = FmusersHelperRoute::getResetRoute();
			$itemid = $itemid !== null ? '&Itemid='.$itemid : '';
			$route	= 'index.php?option=com_fmusers&view=reset&layout=confirm'.$itemid;
	...
	{
		// Check the request token.
		// Commented out since the user will be making this request from an email link
		...
		if ($return instanceof Exception)
		{
			...
			$itemid = FmusersHelperRoute::getResetRoute();
			$itemid = $itemid !== null ? '&Itemid='.$itemid : '';
			$route	= 'index.php?option=com_fmusers&view=reset&layout=complete'.$itemid;
	...
	public function complete()
	{
		...
		$app	= JFactory::getApplication();
		$model	= $this->getModel('Reset', 'FmusersModel');		$data	= JRequest::getVar('jform', array(), 'post', 'array');
